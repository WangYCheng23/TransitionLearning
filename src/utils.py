...
def readParser():
    ...
    parser.add_argument('--seed', type=int, default=912, metavar='N', help='random seed (default: 18)')
    # world model network structure config
    parser.add_argument('--pred_hidden_size', type=int, default=512, metavar='E', help='hidden size for predictive model')
    ...
    # save and load model
    parser.add_argument("--save_model_interval", default=1e3, type=int, help='save model interval')
